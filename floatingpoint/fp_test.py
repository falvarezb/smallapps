...
def test_fp_gen():
    ...
    assert next(fp_generator) == FP(0.00000000000012343, "0011110101000001010111110000100011001111011111011000010001010000", Decimal('0.0000000000001234300000000000102340991445314016317948146994609714965918101370334625244140625'), -43)
    assert next(fp_generator) == FP(0.00000000000012343000000000004, "0011110101000001010111110000100011001111011111011000010001010001", Decimal('0.00000000000012343000000000003547764811160377940497012878851013084613441606052219867706298828125'), -43)
